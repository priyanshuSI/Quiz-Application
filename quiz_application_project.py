...
class FirstPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        b1 = tk.Button(border, text="SUBMIT", font=("Arial", 17, "bold"), bd=7, bg="#2196F3", fg="white",
                       command=verify)
...
class SecondPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        f2.place(x=0, y=50)
        l2 = tk.Label(f2, text="Read all the instructions carefully before attempting the test.",
                      font=("Arial", 13, "italic"), bg="white")
        l2.place(x=220, y=47)
        ...
        l4.place(x=50, y=155)
        l5 = tk.Label(f2, text="3. There is a NEGATIVE MARKING of -25%(0.25 marks on every question).",
                      font=("Arial", 14), bg="white")
        l5.place(x=50, y=190)
        l6 = tk.Label(f2,
                      text="4. Once you click on NEXT button, you will not be able to come back to that question later.",
                      font=("Arial", 14), bg="white")
        l6.place(x=50, y=225)
        l7 = tk.Label(f2, text="5. Press the END TEST button only when you have completed the test.",
                      font=("Arial", 14), bg="white")
        l7.place(x=50, y=260)
        l8 = tk.Label(f2, text="6. No marks will be deducted for skipping the questions.", font=("Arial", 14),
                      bg="white")
        l8.place(x=50, y=295)
        l9 = tk.Label(f2, text="ALL THE BEST", font=("Arial", 20), bg="white")
        l9.place(x=530, y=390)

        b1 = tk.Button(self, text="Back", font=("Arial", 14, "bold"), bd=5, bg="red", fg="white", pady=5, padx=3,
                       command=lambda: controller.show_frame(FirstPage))
        b1.place(x=50, y=550)
        b2 = tk.Button(self, text="Proceed", font=("Arial", 14, "bold"), bd=5, bg="#2196F3", fg="white", pady=5, padx=3,
...
class ThirdPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        b1 = tk.Button(self, text="End Test", font=("Arial", 14, "bold"), bd=5, bg="red", fg="white", pady=5, padx=3,
                       command=lambda: go_to_result(controller))
        b1.place(x=50, y=550)
        b2 = tk.Button(self, text="Next", font=("Arial", 14, "bold"), bd=5, bg="#2196F3", fg="white", pady=5, padx=3,
        ...
        b3 = tk.Button(self, text="Clear Response", font=("Arial", 14, "bold"), bd=5, bg="#2196F3", fg="white", pady=5,
                       padx=3, command=clear_response)
        ...
        l1.place(x=15, y=15)
        l2 = tk.Label(f2, text="Which of the following is not a keyword in python?", font=("Arial", 25, "bold"),
                      padx=20, pady=10)
        l2.place(x=100, y=15)
        ...
        r1 = tk.Radiobutton(f3, text="true", font=("Arial", 20), bg="white", variable=var, value=1, pady=5,
                            command=collect_response)
        r1.place(x=20, y=30)
        r2 = tk.Radiobutton(f3, text="False", font=("Arial", 20), bg="white", variable=var, value=2, pady=5,
                            command=collect_response)
        r2.place(x=20, y=100)
        r3 = tk.Radiobutton(f3, text="else", font=("Arial", 20), bg="white", variable=var, value=3, pady=5,
                            command=collect_response)
        r3.place(x=20, y=170)
        r4 = tk.Radiobutton(f3, text="for", font=("Arial", 20), bg="white", variable=var, value=4, pady=5,
                            command=collect_response)
        r4.place(x=20, y=240)
...
class FourthPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        l1.place(x=15, y=15)
        l2 = tk.Label(f2, text="Which one of the following is the correct extension of the Python file?",
                      font=("Arial", 25, "bold"), padx=20, pady=10)
        l2.place(x=100, y=15)
        ...
        r1 = tk.Radiobutton(f3, text=".python", font=("Arial", 20), bg="white", variable=var, value=1, pady=5,
                            command=collect_response)
        r1.place(x=20, y=30)
        r2 = tk.Radiobutton(f3, text=".py", font=("Arial", 20), bg="white", variable=var, value=2, pady=5,
                            command=collect_response)
        r2.place(x=20, y=100)
        r3 = tk.Radiobutton(f3, text=".pl", font=("Arial", 20), bg="white", variable=var, value=3, pady=5,
                            command=collect_response)
        r3.place(x=20, y=170)
        r4 = tk.Radiobutton(f3, text=".p", font=("Arial", 20), bg="white", variable=var, value=4, pady=5,
                            command=collect_response)
        r4.place(x=20, y=240)
...
class FifthPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        l1.place(x=15, y=15)
        l2 = tk.Label(f2, text="Which of the following is used to define a block of code in Python language?",
                      font=("Arial", 25, "bold"), padx=20, pady=10)
        l2.place(x=100, y=15)
        ...
        r1 = tk.Radiobutton(f3, text="Indentation", font=("Arial", 20), bg="white", variable=var, value=1, pady=5,
                            command=collect_response)
        r1.place(x=20, y=30)
        r2 = tk.Radiobutton(f3, text="Key", font=("Arial", 20), bg="white", variable=var, value=2, pady=5,
                            command=collect_response)
        r2.place(x=20, y=100)
        r3 = tk.Radiobutton(f3, text="Brackets", font=("Arial", 20), bg="white", variable=var, value=3, pady=5,
                            command=collect_response)
        r3.place(x=20, y=170)
        r4 = tk.Radiobutton(f3, text="All of the mentioned", font=("Arial", 20), bg="white", variable=var, value=4,
                            pady=5, command=collect_response)
        r4.place(x=20, y=240)
...
class SixthPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        l1.place(x=15, y=15)
        l2 = tk.Label(f2, text="Which keyword is used for function in Python language?", font=("Arial", 25, "bold"),
                      padx=20, pady=10)
        l2.place(x=100, y=15)
        ...
        r1 = tk.Radiobutton(f3, text="Function", font=("Arial", 20), bg="white", variable=var, value=1, pady=5,
                            command=collect_response)
        r1.place(x=20, y=30)
        r2 = tk.Radiobutton(f3, text="Fun", font=("Arial", 20), bg="white", variable=var, value=2, pady=5,
                            command=collect_response)
        r2.place(x=20, y=100)
        r3 = tk.Radiobutton(f3, text="Def", font=("Arial", 20), bg="white", variable=var, value=3, pady=5,
                            command=collect_response)
        r3.place(x=20, y=170)
        r4 = tk.Radiobutton(f3, text="def", font=("Arial", 20), bg="white", variable=var, value=4, pady=5,
                            command=collect_response)
        r4.place(x=20, y=240)
...
class SeventhPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        b1 = tk.Button(self, text="End Test", font=("Arial", 14, "bold"), bd=5, bg="red", fg="white", pady=5, padx=3,
                       command=lambda: controller.show_frame(EighthPage))
        b1.place(x=50, y=550)
        ...
        l1.place(x=15, y=15)
        l2 = tk.Label(f2, text="Which of the following character is used to give single-line comments in Python?",
                      font=("Arial", 25, "bold"), padx=15, pady=10)
        l2.place(x=100, y=15)
        ...
        r1 = tk.Radiobutton(f3, text="//", font=("Arial", 20), bg="white", variable=var, value=1, pady=5,
                            command=collect_response)
        r1.place(x=20, y=30)
        r2 = tk.Radiobutton(f3, text="!", font=("Arial", 20), bg="white", variable=var, value=2, pady=5,
                            command=collect_response)
        r2.place(x=20, y=100)
        r3 = tk.Radiobutton(f3, text="#", font=("Arial", 20), bg="white", variable=var, value=3, pady=5,
                            command=collect_response)
        r3.place(x=20, y=170)
        r4 = tk.Radiobutton(f3, text="/*", font=("Arial", 20), bg="white", variable=var, value=4, pady=5,
                            command=collect_response)
        r4.place(x=20, y=240)
...
class EighthPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        b1 = tk.Button(self, text="Home", font=("Arial", 14, "bold"), bd=5, bg="orange", fg="white", pady=5, padx=3,
                       command=lambda: controller.show_frame(FirstPage))
        b1.place(x=1270, y=550)

        f1 = tk.Frame(self, height=60, width=1400, bg="orange")
        f1.place(x=0, y=0)
        l1 = tk.Label(f1, text="Click on \"Show Result\" button to know your result ", font=("Arial", 12), padx=30,
                      pady=3)
        l1.place(x=520, y=18)
        ...
        def calculate_result():
            ...
            if (score == 5):
                l1 = tk.Label(self, text='"excellent work"', font=("Arial", 32, "bold"), bg="light blue", padx=15,
                              pady=5)
                l1.place(x=430, y=400)
            elif (score > 3):
                l2 = tk.Label(self, text='"keep practicing"', font=("Arial", 32, "bold"), bg="light blue", padx=15,
                              pady=5)
            ...
            l1 = tk.Label(self, text=f"Your score is: {score} marks out of 5", font=("Arial", 17, "bold"), padx=15,
                          pady=5)
        ...
        f2.place(x=0, y=60)
        b2 = tk.Button(f2, text="Show Result", font=("Arial", 14, "bold"), bd=5, bg="red", fg="white", pady=5, padx=3,
